function export_m18_d08_official_matlab_self_sensitivity(output_path)
% Frozen diagnostic-only MATLAB start-point self-sensitivity probe for official D08.
% See docs/validation/M18_D08_OFFICIAL_MATLAB_SELF_SENSITIVITY.md.
...
assert(isequal(opt_idx(:)',expected_opt_idx), 'Frozen official D08 free-parameter contract changed.');
...
payload.protocol = 'm18-d08-official-matlab-self-sensitivity-1';
...
fprintf('M18 official D08 MATLAB self-sensitivity exported: %d one-spacing starts\n',numel(variants));
end
