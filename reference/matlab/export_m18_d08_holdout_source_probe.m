function export_m18_d08_holdout_source_probe(output_path)
% Frozen diagnostic-only Ridders source probe for the failed D08 holdout.
% See docs/validation/M18_D08_HOLDOUT_SOURCE_PROBE.md.
...
source_row = 38; % one-based MATLAB iter row; frozen before execution
...
payload.protocol = 'm18-d08-holdout-source-probe-1';
...
fprintf('M18 D08 holdout source probe exported: row %d components %d\n', source_row, component_count);
end
