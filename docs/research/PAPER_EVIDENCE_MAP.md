...
| CPU compatibility and JAX CPU backend preserve tested outputs | READY / POST-FIX REMEASURED | `gpu_validation_results/m18_s9_cpu_postfix_revalidation.json`; Actions run `36255732941`; source `0a40e708`; max fit-objective gap `0.006783711260709424` vs frozen `0.1` criterion; repeated raw outputs byte-identical |
