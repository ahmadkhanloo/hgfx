...
**Status:** IN PROGRESS / PUBLICATION / P1–P3/P5/P6 DONE; P6A-1/P6A-2 DONE; P7/P8 OPEN  
...
- remaining: lock exact P7 candidate, run P8 independent audit, then freeze P6A only after P8 PASS.
