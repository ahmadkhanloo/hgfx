...
## Current execution authority — 2026-09-18

HGFX `v1.0.0` is **RELEASED / CLOSED**. Use [version policy](VERSION_POLICY.md), [live TODO](V1_TODO.md), [release gate](V1_RELEASE_GATE.md), [final release provenance](../validation/V1_FINAL_RELEASE_PROVENANCE.md), and [evidence index](../validation/V1_EVIDENCE_INDEX.md) as the frozen v1 authority set.
...
Product-line decision recorded 2026-09-18: v1.0.0 remains the immutable MATLAB HGF Toolbox 8.2.0 compatibility release and paper-1 validated-reproduction anchor. v1.1.x is the active additive line. Current `main` carries package metadata `1.1.0` plus opt-in MAP, VKF, dual-stream AR1 and project response helpers; 1.1.0 is not yet tagged, released, or published to PyPI. See [VERSION_POLICY.md](VERSION_POLICY.md) and [V1_1 usage](../user/V1_1.md).
...
Methods-paper work is a separate future objective and was not required to close the HGFX v1.0.0 product/release milestone. Paper 1 follows the v1 validated-reproduction claim in [VERSION_POLICY.md](VERSION_POLICY.md); GPU speedup checkboxes above are design history and are not paper-1 headlines.
