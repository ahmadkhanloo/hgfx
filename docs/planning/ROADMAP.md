...
Product-line decision recorded 2026-09-18: v1 remains the MATLAB HGF Toolbox 8.2.0 compatibility line and the paper-1 validated-reproduction claim. v2 is not started; the current owner decision in [VERSION_POLICY.md](VERSION_POLICY.md) is provisional only and is not a task queue.
