...
M0–M17 have recorded gate evidence within their tested scope. M18 scientific recovery remains FAIL; M18B corrected gate passes locally and in CI, with archived raw evidence. The active work is paired MATLAB validation of the numerical-horizon and recovery failures; see the [current correction plan](docs/planning/MATLAB_PARITY_RECOVERY_PLAN.md).
