#!/usr/bin/env python3
"""Prepare one frozen M18C.2 paired MATLAB/HGFX horizon shard.

Widens the historical S7 generator to the preregistered 128/256/512/1024 grid
without changing seed, truth-vector, or simulation semantics.
"""
